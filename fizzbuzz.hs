...
main = do
    ...
    nums <- readLn
    putStrLn "For multiples of what numbers shall we print 'Fizz'?"
    fizzNum <- readLn
    putStrLn "For multiples of what numbers shall we print 'Buzz'?"
    buzzNum <- readLn
    mapM_ putStrLn $ fizzBuzz nums fizzNum buzzNum
